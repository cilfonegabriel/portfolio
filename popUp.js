...
const workData = [{
    ...
    liveLink: 'https://github.com/cilfonegabriel/portfolio',
    source: 'https://github.com/cilfonegabriel',
},
{
    name: 'Keeping track of hundreds of components',
    description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Itaque aperiam, laudantium repellat maiores rerum id recusandae ratione error, fuga modi sapiente sequi minima vitae similique voluptas perferendis, eum possimus aut.',
...
const popUp =  document.createElement('div'); //creamos elemento nodo
popUp.classList.add('popUp'); //agregar clases al elemento de tipo lectura
    ...
    popUp.innerHTML =  `
        ...
        <div class="lateral">
            <div class="above">
                ...
                <div class="popUp-btn">
                    <a href="${workData[projectNumber].liveLink}"><button type="button" class="p-btn"></button></a>
                    <a href="${workData[projectNumber].source}"><button type="button" class="p-btn2 btn2"></button></a>
                </div>
        </div>
        <p class="pop-pDesk">   
